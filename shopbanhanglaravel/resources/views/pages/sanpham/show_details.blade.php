...
<div class="product-details"><!--product-details-->
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										<div class="item active">
										  <a href=""><img src="{{URL::to('public/fornt end/image/similar1.jpg')}}" alt=""></a>
										  <a href=""><img src="{{URL::to('public/fornt end/image/similar2.jpg')}}" alt=""></a>
										  <a href=""><img src="{{URL::to('public/fornt end/image/similar3.jpg')}}" alt=""></a>
										</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<img src="{{URL::to('public/fornt end/image/new.jpg')}}" class="newarrival" alt="" />
								<h2>{{$pro_details->product_name}}</h2>
								<p>Mã ID: {{$pro_details->product_id}}</p>
								<img src="{{URL::to('public/fornt end/image/rating.png')}}" alt="" />

                                <form action="{{URL::to('/save-cart')}}" method="post">
                                 {{csrf_field()}}
                                    <span>
                                        <span>{{number_format($pro_details->product_price).'VND'}}</span>
								...
								<a href=""><img src="{{URL::to('public/fornt end/image/share.png')}}" class="share img-responsive"  alt="" /></a>
                    ...
                    <div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
                            ...
                            <!-- dấu '!!' giúp hiển thị ra kí tự đặc biệt -->
